...
echo "   $ kubectl apply -f infra/k8s/bootstrap/cert-manager-cluster-issuer.yaml"
echo "   $ helm upgrade --install stock-intel ./infra/k8s -f ./infra/k8s/values-prod.yaml -n stock-prod --create-namespace"
echo "=============================================================================="
