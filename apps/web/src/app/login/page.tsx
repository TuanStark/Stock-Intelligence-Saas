    ...
    <div className="app-container flex items-center justify-center min-h-screen p-6 relative">
      ...
      <div className="glass-panel font-inter w-full max-w-[420px] p-10 rounded-2xl border border-board-border shadow-2xl">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-surface hover:bg-surface-hover/80 border border-board-border rounded-xl py-3 px-4 font-semibold text-text-primary text-sm shadow-md transition-all duration-200 active:scale-[0.98] hover:scale-[1.01] hover:border-accent/40 disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
        >
          {googleLoading ? (
            <Loader2 size={18} className="pulse text-accent" />
          ) : (
