        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="glass-panel p-4 md:p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#0d1017] border border-white/5 rounded-xl">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-[#171d2a] p-2 px-3 rounded border border-[#2d3748]/40">
                <span className="font-extrabold text-[#00c58e] text-lg md:text-xl tracking-tight">
                  {instrument.symbol}
                </span>
                <span className="text-[10px] text-text-muted font-bold bg-[#0d1017] px-1.5 rounded uppercase">
                  HOSE
                </span>
              </div>

              <div>
                <h1 className="text-sm md:text-base text-white font-extrabold leading-tight m-0">
                  {getCompanyName(instrument.symbol)}
                </h1>
                <p className="text-[11px] text-text-muted m-0 mt-0.5">
                  {instrument.industry || "Capital Markets"}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pl-0 md:pl-6 border-l-0 md:border-l border-[#1a2233] w-full md:w-auto">
              <div className="flex items-baseline gap-2">
                <span
                  className={`font-outfit ${priceColor} text-3xl font-extrabold tracking-tight`}
                >
          ...
          <div className="glass-panel p-0 bg-[#06070a] overflow-hidden flex border border-[#1b2233] rounded-xl relative flex-col h-[580px]">
            ...
            <div className="flex justify-between items-center px-4 py-2 border-b border-[#131822] bg-[#080b11] text-[10px] font-bold text-text-secondary shrink-0">
              ...
              <span className="text-[9px] text-[#7b8a9b] font-extrabold tracking-wide">
            ...
            {signals.length === 0 ? (
              ...
              <div className="flex flex-col gap-3 max-h-[350px] overflow-y-auto pr-1">
                {signals.map((sig) => (
                  <div
                    key={sig.id}
                    className="glass-panel py-3 px-3.5 rounded-lg bg-white/2 flex items-center justify-between border border-white/5 hover:border-white/20 transition-all duration-200"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`badge ${sig.type === "BUY" ? "badge-bullish" : "badge-bearish"} text-[9px] py-0.5 px-2`}
                      >
