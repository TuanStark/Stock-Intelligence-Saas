...
export const MarketFundamentals: React.FC<MarketFundamentalsProps> = ({
  latestQuote,
  tc,
}) => {
      ...
      <div className="flex flex-col gap-3 font-mono text-xs md:text-sm">
        <div className="flex justify-between border-b border-white/5 pb-2">
          ...
          <span className="font-semibold text-white">
            {formatCurrency(latestQuote.open)} VND
          </span>
        </div>
        ...
        <div className="flex justify-between border-b border-white/5 pb-2">
          ...
          <span className="font-semibold text-up">
            {formatCurrency(latestQuote.high)} VND
          </span>
        </div>
        ...
        <div className="flex justify-between border-b border-white/5 pb-2">
          ...
          <span className="font-semibold text-down">
            {formatCurrency(latestQuote.low)} VND
          </span>
        </div>
        ...
        <div className="flex justify-between border-b border-white/5 pb-2">
          ...
          <span className="font-semibold text-ref">
            {formatCurrency(latestQuote.previousClose)} VND
          </span>
        </div>
        ...
        <div className="flex justify-between border-b border-white/5 pb-2">
          ...
          <span className="font-semibold text-white">
            {formatCurrency(latestQuote.volume)}
          </span>
        </div>

        <div className="flex justify-between pb-1">
          <span className="text-text-muted">Giá trị giao dịch</span>
          <span className="font-semibold text-[#00cfff]">
            {formatCurrency(latestQuote.value)} VND
          </span>
        </div>
      </div>
    </div>
