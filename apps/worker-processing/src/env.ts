...
/**
 * Stock Intelligence SaaS — Strongly-Typed Local Environment Configuration for Processing Worker
 */
...
if (missingVars.length > 0) {
  console.error(
    "\n❌ CRITICAL STARTUP ERROR: Missing required environment variables in Processing Worker:",
  );
