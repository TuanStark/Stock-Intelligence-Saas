...
async function main() {
    ...
    const exchanges = await Promise.all([
        ...
        prisma.exchange.upsert({
            where: { code: 'UPCOM' },
            update: {},
            create: { code: 'UPCOM', name: 'Unlisted Public Company Market', market: 'VN' },
        }),
    ]);
    ...
    const sampleInstruments = [
        { symbol: 'VCB', name: 'Vietcombank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'BID', name: 'BIDV', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'CTG', name: 'VietinBank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'TCB', name: 'Techcombank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'MBB', name: 'MB Bank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'VPB', name: 'VPBank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'ACB', name: 'Asia Commercial Bank', sectorId: bankingSector.id, currency: 'VND' },
        { symbol: 'VHM', name: 'Vinhomes', sectorId: realEstateSector.id, currency: 'VND' },
        { symbol: 'VIC', name: 'Vingroup', sectorId: realEstateSector.id, currency: 'VND' },
        { symbol: 'VRE', name: 'Vincom Retail', sectorId: retailSector.id, currency: 'VND' },
        { symbol: 'FPT', name: 'FPT Corporation', sectorId: techSector.id, currency: 'VND' },
        { symbol: 'HPG', name: 'Hoa Phat Group', sectorId: steelSector.id, currency: 'VND' },
    ];
